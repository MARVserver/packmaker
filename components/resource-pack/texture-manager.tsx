...
export function TextureManager({
    ...
    const filteredTextures = textures.filter((t) => {
        // Support both formats: "textures/item/..." and "item/..."
        const normalizedPath = t.path.startsWith('textures/') ? t.path : `textures/${t.path}`
        return normalizedPath.startsWith(`textures/${selectedCategory}`)
    })
